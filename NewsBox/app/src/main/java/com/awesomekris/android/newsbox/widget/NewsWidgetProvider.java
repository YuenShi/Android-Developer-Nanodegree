...
import com.awesomekris.android.newsbox.NewsDetailActivity;
import com.awesomekris.android.newsbox.NewsList;
...
public class NewsWidgetProvider extends AppWidgetProvider {
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        ...
        for (int appWidgetId : appWidgetIds) {
            ...
            Intent clickIntentTemplate = useDetailActivity ? new Intent(context, NewsDetailActivity.class) : new Intent(context, NewsList.class);
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (NewsBoxSyncAdapter.ACTION_DATA_UPDATED.equals(intent.getAction())) {
